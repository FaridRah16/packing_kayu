        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <nav class="navbar navbar-expand-lg navbar-light navbar-admin mb-4">
                    ...
                    <span class="navbar-brand">Dashboard Staff</span>
                    <div class="ms-auto">
                            ...
                            <div class="card-body py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <p class="mb-0">Dashboard Staff Packing Kayu</p>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="staff_estimasi.php?id=<?php echo $estimasi['id']; ?>&status=batal" class="btn btn-sm btn-danger">
