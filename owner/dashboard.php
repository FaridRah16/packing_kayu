...
$query = "SELECT SUM(estimasi_biaya) as total_pendapatan FROM estimasi WHERE status = 'selesai'";
$stmt = $db->prepare($query);
$stmt->execute();
...
$status_data = [
    ...
    $estimasi_diproses,
    $estimasi_selesai,
    $total_estimasi - ($estimasi_pending + $estimasi_diproses + $estimasi_selesai)
];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Dashboard Owner - Estimasi Packing Kayu</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <nav class="navbar navbar-expand-lg navbar-light navbar-admin mb-4">
                    ...
                    <span class="navbar-brand">Dashboard Owner</span>
                    <div class="ms-auto">
                            ...
                            <div class="card-body py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <p class="mb-0">Dashboard Owner Packing Kayu</p>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card stats-card info">
                            <div class="stats-card-body">
                                <div>
                                    <div class="stats-card-title">Total Pendapatan</div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-3">
                            <a href="estimasi.php" class="btn btn-primary">Lihat Semua Estimasi</a>
                        </div>
                    </div>
                </div>
